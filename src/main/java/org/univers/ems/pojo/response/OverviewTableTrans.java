 ...
 */
@Data
public class OverviewTableTrans {
    ...
    private Integer smaller500;

    private Integer middle500;

    private Integer larger500;

    private Integer smaller220;

    private Integer middle220;

    private Integer larger220;

    private Integer smaller110;

    private Integer middle110;

    private Integer larger110;

    private Integer smaller35;

    private Integer middle35;

    private Integer larger35;

    private Integer smaller10;

    private Integer middle10;

    private Integer larger10;

    private Integer smallerOther;

    private Integer middleOther;

    private Integer largerOther;

    private Integer smallerTotal;

    private Integer middleTotal;

    private Integer largerTotal;
}
