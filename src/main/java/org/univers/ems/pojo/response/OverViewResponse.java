...
public class OverViewResponse {
    ...
    private Integer offCount500;

    private Integer offCount220;

    private Integer offCount110;

    private Integer offCount35;

    private Integer offCount10;

    private Integer offCountOther;

    private Integer offCount;

    private Integer onCount500;

    private Integer onCount220;

    private Integer onCount110;

    private Integer onCount35;

    private Integer onCount10;

    private Integer onCountOther;
